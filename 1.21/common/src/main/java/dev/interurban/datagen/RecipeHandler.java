...
public class RecipeHandler extends RecipeProvider {
    ...
    public RecipeHandler(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries);
    }

    /**
     * Defines all recipes for mod blocks and items
     * @param output recipes
     */
    @Override
    protected void buildRecipes(RecipeOutput output) {
        ...
        shaped(RecipeCategory.TRANSPORTATION, CROSSING_LIGHT_DUAL.get(), 1)
                ...
                .define('R', Items.REDSTONE_LAMP)
                .group("lights")
                .unlockedBy(getHasName(CROSSING_LIGHT_DUAL.get()), has(LIGHTS))
                .save(output);
