...
public class SmallSignBlock extends SignBlock {
    ...
    public @NotNull VoxelShape getShape(BlockState state, BlockGetter worldIn, BlockPos pos, CollisionContext context) {
		...
		return switch (direction) {
            case NORTH -> Shapes.box(0.25, 0.0, 0.4375, 0.75, 1.0, 0.625); //4, 0, 7, 12, 16, 10
            case SOUTH -> Shapes.box(0.25, 0.0, 0.375, 0.75, 1.0, 0.5625); //4, 0, 6, 12, 16, 9
            case EAST -> Shapes.box(0.375, 0.0, 0.25, 0.5625, 1.0, 0.75); //6, 0, 4, 9, 16, 12
            case WEST -> Shapes.box(0.4375, 0.0, 0.25, 0.625, 1.0, 0.75); //7, 0, 4, 10, 16, 12
