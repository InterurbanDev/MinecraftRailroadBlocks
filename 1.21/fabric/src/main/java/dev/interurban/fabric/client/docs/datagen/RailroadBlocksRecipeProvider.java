...
import static dev.interurban.fabric.client.docs.datagen.RailroadBlocksItemTagProvider.*;
import static net.minecraft.data.recipes.ShapedRecipeBuilder.shaped;
import static net.minecraft.data.recipes.ShapelessRecipeBuilder.shapeless;


public class RailroadBlocksRecipeProvider extends FabricRecipeProvider {
    public RailroadBlocksRecipeProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
    ...
    public @NotNull String getName() {
        return "RailroadBlocksRecipeProvider";
    }
}