...
public class BlockInit {
    ...
    public static final SignBlock IRON_CROSSBUCK_BLOCK = new SignBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.METAL)
            .strength(2f)
    ...
    public static final PoleBlock IRON_POLE_BLOCK = new PoleBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.METAL)
            .strength(2f)
            .requiresCorrectToolForDrops()
            //.harvestLevel(1)
            //.harvestTool(ToolType.AXE)
    ...
    public static final SignBlock RXR_ADVANCE_BLOCK = new SignBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.METAL)
            .strength(2f)
            .requiresCorrectToolForDrops()
            // .harvestLevel(1)
            // .harvestTool(ToolType.AXE)
    ...
    public static final SmallSignBlock WHISTLE_SIGN_BLOCK = new SmallSignBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.METAL)
            .strength(2f)
            .requiresCorrectToolForDrops()
            // .harvestLevel(1)
            // .harvestTool(ToolType.AXE)
    ...
    public static final SignBlock WOODEN_CROSSBUCK_BLOCK = new SignBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD)
            .strength(1f)
            .requiresCorrectToolForDrops()
            // .harvestLevel(1)
            // .harvestTool(ToolType.AXE)
    ...
    public static final PoleBlock WOODEN_POLE_BLOCK = new PoleBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD)
            .strength(1f)
            .requiresCorrectToolForDrops()
            // .harvestLevel(1)
            // .harvestTool(ToolType.AXE)
