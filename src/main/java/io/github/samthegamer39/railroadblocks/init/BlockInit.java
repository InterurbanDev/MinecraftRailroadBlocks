...
public class BlockInit {
    ...
    public static final SmallSignBlock WHISTLE_SIGN_BLOCK = new SmallSignBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL) //AbstractBlock.Properties.of() is the mojmap version of .create()
            .strength(2f)
            .harvestLevel(1)
            .harvestTool(ToolType.AXE)
            .sound(SoundType.METAL)
