...
public class ItemInit {
    ...
    public static final RegistryObject<BlockItem> WOODEN_POLE = ITEMS.register("wooden_pole",
            () -> new BlockItem(BlockInit.WOODEN_POLE.get(), new Item.Properties().tab(RailroadBlocks.RAILROAD_BLOCKS_TAB)));

    public static final RegistryObject<BlockItem> IRON_POLE = ITEMS.register("iron_pole",
            () -> new BlockItem(BlockInit.IRON_POLE.get(), new Item.Properties().tab(RailroadBlocks.RAILROAD_BLOCKS_TAB)));

    public static final RegistryObject<BlockItem> WOODEN_CROSSBUCK = ITEMS.register("wooden_crossbuck",
            () -> new BlockItem(BlockInit.WOODEN_CROSSBUCK.get(), new Item.Properties().tab(RailroadBlocks.RAILROAD_BLOCKS_TAB)));

    public static final RegistryObject<BlockItem> IRON_CROSSBUCK = ITEMS.register("iron_crossbuck",
            () -> new BlockItem(BlockInit.IRON_CROSSBUCK.get(), new Item.Properties().tab(RailroadBlocks.RAILROAD_BLOCKS_TAB)));

    public static final RegistryObject<BlockItem> RXR_ADVANCE = ITEMS.register("rxr_advance_sign",
            () -> new BlockItem(BlockInit.RXR_ADVANCE.get(), new Item.Properties().tab(RailroadBlocks.RAILROAD_BLOCKS_TAB)));
