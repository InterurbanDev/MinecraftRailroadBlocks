...
public class ModItemTagsProvider extends ItemTagsProvider {
    public ModItemTagsProvider(DataGenerator arg, BlockTagsProvider arg2, @Nullable ExistingFileHelper existingFileHelper) {
        super(arg, arg2, RailroadBlocks.MOD_ID, existingFileHelper);
    }

    // Add your tag entries here.
    @Override
    protected void addTags() {
        for (Tag.Named<Item> tag : ITEM_TAG_LIST) {
